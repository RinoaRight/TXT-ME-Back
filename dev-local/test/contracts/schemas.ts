...
export const UsersSetActiveAvatarSuccessSchema = z.object({
  message: z.literal("Active avatar updated"),
  avatarId: z.string(),
});
...
// UsersGetUserAvatar
// Returns { userId, username, avatarDataUrl } for specific avatarId
// Returns { userId, username, avatarId, avatarDataUrl } for "active" request
